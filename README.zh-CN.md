...
| <img src="docs/assets/status-done.svg" alt="完成" width="82"> | model/runtime/generation/policy/sandbox/skills/provider_options DTO | 已实现 |
| <img src="docs/assets/status-done.svg" alt="完成" width="82"> | Claude tool permission 的 embedded approval broker | 已实现 |
